...
RangeData TransformRangeData(const RangeData& range_data,
  ...
  return RangeData{
      transform * range_data.origin,                     //对激光原点进行变换
      TransformPointCloud(range_data.returns, transform),//对击中点进行变换
      TransformPointCloud(range_data.misses, transform), //对没有击中的点也变换
  };
}
