...
// 给定四元数 3D旋转，返回弧度值的yaw角， 即返回沿z轴方向的旋转的弧度
template <typename T>
...
// vector.
//与上面函数相反的操作。给定绕angle-axis旋转，返回四元数。
template <typename T>
...
/*投影到2维平面xy。
具体：取3D刚体变换的前2维，和yaw， 返回2d刚体变换[x,y,yaw]
*/
template <typename T>
