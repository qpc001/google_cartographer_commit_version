...
/////////////////////////////////////////////////////////////////////////////
/// \brief The NodeId struct
/// \brief 位姿图里面常用到的节点ID
/// \brief {轨迹id,节点索引} 唯一地表示一个节点
/// /////////////////////////////////////////////////////////////////////////
struct NodeId {
...
///////////////////////////////////////////////////////////////////////////////
/// \brief The SubmapId struct
/// \brief Pose Graph里面常用到的子图ID
/// \brief {轨迹id , 子图索引} 可以唯一的表示一个子图
/// ///////////////////////////////////////////////////////////////////////////
struct SubmapId {
    int trajectory_id;    //轨迹id
    int submap_index;     //子图索引
...
///////////////////////////////////////////////////////////////////////////////
/// \brief MayById 类
/// \brief 可以看做是 std::map 的封装
/// \brief 但是又于 轨迹ID , 时间戳 , 各种ID相关
///////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    /////////////////////////////////////////////////////////////////
    /// \brief EndOfTrajectory
    /// \brief 可以看到这个函数, 是直接返回(轨迹ID+1)所对应的起始
    /// \param trajectory_id
    /// \return 因此, 这个返回并非真正的轨迹的末尾
    ///         在实际使用当中, 还会加上一步 std::prev()来取上一个数据,这样
    ///         才是真正的 (trajectory_id) 所对应的末尾的数据
    /////////////////////////////////////////////////////////////////
...
private:
    // 可通过索引进行映射的数据
    struct MapByIndex {
        bool can_append_ = true;        //是否可追加
        std::map<int, DataType> data_;  //<索引,数据>
    };
