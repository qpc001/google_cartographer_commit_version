...
public:
    ...
    // 2. 平移量的残差项
    // 3. 旋转量的残差项
    // 使用ceres对三个误差项构成的cost func 进行优化 , 得到优化位姿pose_estimate
...
private:
    const proto::CeresScanMatcherOptions2D options_;      //配置选项
    ceres::Solver::Options ceres_solver_options_;         //ceres配置
};
